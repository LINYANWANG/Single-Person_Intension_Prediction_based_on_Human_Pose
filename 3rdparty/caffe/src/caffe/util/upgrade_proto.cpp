...
void ReadNetParamsFromTextMemoryFileOrDie(std::istream* file_pointer,
											NetParameter* param){
  CHECK(ReadProtoFromTextFileMemory(file_pointer, param))
      << "Failed to parse NetParameter file: " << "Memory";
  UpgradeNetAsNeeded("Memory", param);
}

void ReadNetParamsFromBinaryFileMemoryOrDie(std::istream* model_pointer,
                                      NetParameter* param) {
  CHECK(ReadProtoFromBinaryFileMemory(model_pointer, param))
      << "Failed to parse NetParameter file: " << "Memory";
  UpgradeNetAsNeeded("Memory", param);
}
